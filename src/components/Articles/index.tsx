...
import { ArticleCard, ArticleCardSkeleton } from 'gatsby-theme-portfolio-minimal/src/components/ArticleCard';
            ...
            if (mediumArticles.length > 0) {
                mediumArticles.forEach((article) => {
                    articleList.push({
                        ...
                        title: article.title,
                        publishedAt: new Date(article.published), // https://stackoverflow.com/a/5646753
                        link: article.link,
                    });
                });
            }
